...
from wtforms import SubmitField, IntegerField, StringField, TextAreaField, URLField, PasswordField
...
class RegisterForm(FlaskForm):
    ...
    confirm_password = PasswordField(
        ...
        validators=[
            ...
            EqualTo(
                "password",
                message="This password is not the same that one in the password field"
            )
        ]
    )
